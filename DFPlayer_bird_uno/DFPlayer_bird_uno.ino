...
// Pin Definitions
const int motionPin = 7;           // Digital pin for the motion sensor
...
// DFPlayer Setup
SoftwareSerial mySoftwareSerial(10, 11); // RX, TX for Arduino Uno
...
unsigned long readPotentiometer() {
  ...
  // Map the pot value (0-1023) to a desired playback duration range (1000ms to 30000ms)
  return map(potValue, 0, 1023, 1000, 30000); // Map to 1s to 30s
}
