...
unsigned long timerDelay = 55000;
////////////////////////
/////////////////////////////////////////////////////DO NOT DISTURB STOP ///////////////////////////
...
/////////////////////////////////////////////////////DO NOT DISTURB START ///////////////////////////
    ...
    int x = ThingSpeak.writeField(myChannelNumber, 11, valueOf[NUM_READS/2].moisture1, myWriteAPIKey);
    if(x == 200){
      Serial.println("Channel 11 update successful.");
    }
    else{
...
delay(50000);
    ...
    int y = ThingSpeak.writeField(myChannelNumber,12, valueOf[NUM_READS/2].moisture2, myWriteAPIKey);
    if(y == 200){
      Serial.println("Channel 12 update successful.");
    }
    else{
