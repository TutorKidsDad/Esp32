...
/////////////////////////////////////////////////////DO NOT DISTURB START ///////////////////////////
    ...
    int x = ThingSpeak.writeField(myChannelNumber, 1, valueOf[NUM_READS/2].moisture1, myWriteAPIKey);
    if(x == 200){
...
delay(20000);
    ...
    int y = ThingSpeak.writeField(myChannelNumber,2, valueOf[NUM_READS/2].moisture2, myWriteAPIKey);
    if(y == 200){
