...
/////////////////////////////////////////////////////DO NOT DISTURB START ///////////////////////////
    ...
    int x = ThingSpeak.writeField(myChannelNumber, 3, valueOf[NUM_READS/2].moisture1, myWriteAPIKey);
    if(x == 200){
...
delay(30000);
    ...
    int y = ThingSpeak.writeField(myChannelNumber,4, valueOf[NUM_READS/2].moisture2, myWriteAPIKey);
    if(y == 200){
      Serial.println("Channel 4 update successful.");
    }
    else{
